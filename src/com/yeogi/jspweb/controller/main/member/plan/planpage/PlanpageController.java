package com.yeogi.jspweb.controller.main.member.plan.planpage;
...
@WebServlet("/main/member/plan/planpage/plan-page")
public class PlanpageController extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher 
			= request.getRequestDispatcher("/WEB-INF/views/main/member/plan/planpage/plan-page.jsp");
