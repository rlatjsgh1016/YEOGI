				...
				<div class="select-container write-new" style="visibility: hidden">
					...
					<fieldset class="select-field">
						<div>
							...
							<input id="select-title" type="text" name="select-title" style="width:200px; height:38px;">
						</div>
						<div>
							<label for="select-nation">여행도시:&nbsp</label>
							<select id="select-nation"  name="select-nation" style="height: 38px;">
						...
						<div>
       					...
       					<div>
    						...
    						<select id="select-period" name="select-period" style="height: 38px;">
        					<%for(Day d : dayList){ %>
						...
						<div>
							<label for="select-companion">여행인원:&nbsp</label>
              				<input type="number" id="select-companion" name="select-companion" min="1" style="width:50px; height: 32px;">
	            		</div>
	            		<div>
							<label for="select-theme">여행테마:&nbsp</label>
							<select id="select-theme"  name="select-theme" style="height: 38px;">
