					...
					<table border="1">
						<thead>
							<tr>
								...
								<td width="300px">${tPlanPost.title}</td>
...
<form method="post">
	<div class="modal">
	<%-- <input id="tour-plan-id" type="hidden" name="tour-plan-id" value="${}">
	<input id="tour-plan-loc-id" type="hidden" name="tour-plan-loc-id" value="${}"> --%>
		<div id="memoscreen">
			<ul>
...
<form method="post">
	<div class="modal">
		<div id="memoscreen">
			<ul>
				<li><input type="hidden" name="time" value="25:00" />25:00</li>
				<li><input id="memo-title" type="text" name="memo-title" 
					placeholder="메모 제목이 무엇이죠? :)" maxlength="50" required/></li>
				<li><textarea name="memo-content" 
						placeholder="여행지에 대해 간단한 메모를 해주세요! :)" maxlength="300" wrap="hard"></textarea></li>
...
<form method="post">
	<div class="modal">
		<div id="memoscreen">
			<ul>
				<li><input type="hidden" name="time" value="26:00" />26:00</li>
				<li><input id="memo-title" type="text" name="memo-title" 
					placeholder="메모 제목이 무엇이죠? :)" maxlength="50" required/></li>
				<li><textarea name="memo-content" 
						placeholder="여행지에 대해 간단한 메모를 해주세요! :)" maxlength="300" wrap="hard"></textarea></li>
...
<form method="post">
	<div class="modal">
		<div id="memoscreen">
			<ul>
				<li><input type="hidden" name="time" value="27:00" />27:00</li>
				<li><input id="memo-title" type="text" name="memo-title" 
					placeholder="메모 제목이 무엇이죠? :)" maxlength="50" required/></li>
				<li><textarea name="memo-content" 
						placeholder="여행지에 대해 간단한 메모를 해주세요! :)" maxlength="300" wrap="hard"></textarea></li>
...
<form method="post">
	<div class="modal">
		<div id="memoscreen">
			<ul>
				<li><input type="hidden" name="time" value="28:00" /></li>
				<li><input id="memo-title" type="text" name="memo-title" 
					placeholder="메모 제목이 무엇이죠? :)" maxlength="50" required/></li>
				<li><textarea name="memo-content" 
						placeholder="여행지에 대해 간단한 메모를 해주세요! :)" maxlength="300" wrap="hard"></textarea></li>
...
<form method="post">
	<div class="modal">
		<div id="memoscreen">
			<ul>
				<li><input type="hidden" name="time" value="29:00" /></li>
				<li><input id="memo-title" type="text" name="memo-title" 
					placeholder="메모 제목이 무엇이죠? :)" maxlength="50" required/></li>
				<li><textarea name="memo-content" 
						placeholder="여행지에 대해 간단한 메모를 해주세요! :)" maxlength="300" wrap="hard"></textarea></li>
